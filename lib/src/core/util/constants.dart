...
const String PLAY_STORE_URL =
    'https://play.google.com/store/apps/details?id=com.qubilix.masjidmodeapp';
...
const Color kLightPrimary = Color(0xFFFFC107);
const Color kLightPrimaryQ = Color(0x000);
...
const Color kDarkPrimary = Colors.amberAccent;
const Color kDarkPrimaryQ = Color(0x000);
